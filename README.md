...
Automated visual inspection system using deep learning to detect defects (missing components, solder defects, misalignments) on PCB assemblies.
# ECI-Vision: Electronic Component Inspection System
